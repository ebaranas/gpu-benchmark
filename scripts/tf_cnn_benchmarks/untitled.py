...
def benchmark_one_step(sess,
  ...
  print(profiler, step, _NUM_STEPS_TO_PROFILE)
  print('should_profile', should_profile) #TAG!
  ...
  print('need_options_and_metadata', need_options_and_metadata) #TAG!
  need_options_and_metadata = True
  if need_options_and_metadata:
    print('need options and metadata') #TAG!
  ...
  need_options_and_metadata = True
  if need_options_and_metadata:
    print('I need_options_and_metadata') #TAG!
    if should_profile:
...
def make_params_from_flags():
  ...
  print('flag_values', flag_values) # TAG!
  ...
  def _benchmark_graph(self, graph_info):
    ...
    with sv.managed_session(
      ...
      while done_fn(): #TAG!
        ...
        print('summary_str', summary_str) #TAG!
